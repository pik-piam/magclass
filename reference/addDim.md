...
name "dimName" with an empty data column with the name "item".
...
- item:
  ...
  One or more names of items in the new dimension. If more than one is
  given, behavior depends on the expand argument.
